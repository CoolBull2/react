...
import { addTodo } from '../features/tood/totoSlice'
  ...
  return (
    <form action="" onSubmit={addTodoHandler} className="space-x-3 mt-12">
      <input
        ...
        focus:ring-2 focus:ring-indiggo-900 test-base outline-none text-gray-100 py-1 px-3 leading-8
        transition-colors duration-200 ease-in-out"
        placeholder="Entere Todo..."
        value={input}
